...
std::vector<std::string> story = {
  ...
  /*13*/"[???] Cristol Nevel... so you've finally awaken\n",
  ...
  /*17*/"[Sophia Lazarus] You're in the kingdom of Aurelia under the rule of king (king's name). I'm Sophia Lazarus, second in line for the throne\n",
  /*18*/"[PLAYER] Why am I here? Why are you keeping me alive?\n",
  /*19*/"[SYSTEM] Sophia doesn't answer, getting up to leave the cell\n",
  /*20*/"[Sophia Lazarus] I will have a guard of mine bring you food and fresh clothing soon. Don't be difficult, just take the offerings. We have much to dicuss tomorrow.\n",
