...
std::vector<std::string> story = {
  ...
  /*0*/"Please enter a speed from 1 - 20. The lower the speed, the faster text will erase from the screen.\nIt will be easier to read at higher numbers, but the game will move faster at a lower number.\nYou can change this later in the game options.\nEnter a value now: ",
  /*1*/"Welcome, adventurer.\nEnter your name here: ",
  /*2*/"Would you like to start the tutorial or skip to the story? (For tutorial, type \"t\", for the story, type \"s\"): ",
  /*3*/"Hello, ", 
  /*4*/name,
